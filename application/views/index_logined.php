...
foreach($data as $val){
 ?>
  	<li class="Blog" id="blog_24027">
		<h2 class="BlogAccess_true BlogTop_0"><a href="user/viewPost_logined?id=<?php echo $val->BLOG_ID?>"><?php echo $val->TITLE ;?></a>
		</h2>
		<div class="outline">
			  <span class="time"><?php echo $_SESSION['NAME']; ?>发表于 <?php echo $val->ADD_TIME ;?></span>
			  <span class="catalog">分类: <a href="#"><?php echo $val->NAME ;?></a></span>
			  <span class="stat">统计: 1评/<?php echo $val->CLICK_RATE; ?>阅</span>
			  <span class="blog_admin">( <a href="newBlog.htm">修改</a> | <a href="Delblog/del?id=<?php echo $val->BLOG_ID?>">删除</a> )</span>	  
		</div>
		<div class="TextContent" id="blog_content_24027">
						<?php echo iconv_substr($val->CONTENT,0,10);?>...
			<div class="fullcontent">
				<a href="user/viewPost_logined?id=<?php echo $val->BLOG_ID?>">阅读全文...</a>
			</div>
		</div>
	</li>
	<?php } ?>
